...
class AAgent:
    ...
    def __init__(self, config_file_path: str):
        ...
        self.goals = {
            ...
            "RandomWander": AloneGoals.RandomWander(self),
            "ReturnToBase": AloneGoals.ReturnToBase(self),
            "UnloadFlowers": AloneGoals.UnloadFlowers(self),
            "FlowerCollector": AloneGoals.FlowerCollector(self)
        }
